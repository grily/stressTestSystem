 ...
 * 重写了html模板exporter类，为了兼容5.1~5.4版本的jmeter（jmeter4.0需要删除该类）
 *
 * @since 3.0 change 5.3
 */
public class LocalHtmlTemplateExporter extends AbstractDataExporter {
    ...
    private static final Logger log = LoggerFactory.getLogger(LocalHtmlTemplateExporter.class);
    ...
    public void export(SampleContext context, File file,
        ...
        LocalJOrphanUtils.canSafelyWriteToFolder(outputDir, this::htmlReportFileFilter);
